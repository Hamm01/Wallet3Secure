            ...
            <div className='flex flex-col gap-4 my-10 border p-6 rounded-md'>
                ...
                {showMemonic && mnemonicWords.length > 0 && (
                    <div className="flex flex-col w-full items-center justify-center"
                        onClick={() => copyToClipboard(mnemonicWords.join(" "))}><div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 justify-center w-full items-center mx-auto my-8'>
